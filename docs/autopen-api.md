> Para el asistente que lea esto: Autopen es un servicio HTTP. No hay paquete npm, no hay registro privado, no hay SDK que instalar y ninguna credencial de registro. Solo la URL base y una API key, usadas desde el servidor.
